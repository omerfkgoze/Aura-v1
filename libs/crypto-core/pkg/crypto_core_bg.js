...
export function create_envelope_with_metadata(
  ...
  const ret = wasm.create_envelope_with_metadata(
    version,
    algorithm,
    ptr0,
    len0,
...
export const KeyRotationError = Object.freeze({
  ...
  7: 'SecurityEventProcessingError',
  InvalidRotationTiming: 8,
  8: 'InvalidRotationTiming',
  UserPreferencesNotFound: 9,
  9: 'UserPreferencesNotFound',
});
/**
...
const AADValidatorFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const Argon2ParamsFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const AsyncCryptoOperationFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class BatchConfig {
  ...
  constructor(size, max_concurrent, integrity_validation, performance_monitoring) {
    const ret = wasm.batchconfig_new(
      size,
      max_concurrent,
...
const BenchmarkResultFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class BenchmarkResult {
  ...
  constructor(duration_ms, memory_used_mb, iterations_tested, success, error_message) {
    var ptr0 = isLikeNone(error_message)
      ? 0
      : passStringToWasm0(error_message, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    const ret = wasm.benchmarkresult_new(
      duration_ms,
      memory_used_mb,
      iterations_tested,
      success,
...
const CryptoEnvelopeFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const DebugInterfaceFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const DeviceCapabilitiesFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class DeviceCapabilities {
  ...
  constructor(
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.devicecapabilities_new(
      device_class,
      available_memory,
      cpu_cores,
      has_secure_enclave,
...
const DeviceCapabilityDetectorFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class DeviceCapabilityDetector {
  ...
  detect_capabilities(available_memory_mb, cpu_cores, platform, has_secure_enclave) {
    const ptr0 = passStringToWasm0(platform, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.devicecapabilitydetector_detect_capabilities(
      this.__wbg_ptr,
      available_memory_mb,
      cpu_cores,
      ptr0,
  ...
  get_optimal_argon2_params(capabilities) {
    ...
    const ret = wasm.devicecapabilitydetector_get_optimal_argon2_params(
      this.__wbg_ptr,
      capabilities.__wbg_ptr
    );
  ...
  benchmark_argon2_performance(test_params, target_duration_ms) {
    ...
    const ret = wasm.devicecapabilitydetector_benchmark_argon2_performance(
      this.__wbg_ptr,
      test_params.__wbg_ptr,
      target_duration_ms
    );
    return ret;
  }
  ...
  select_adaptive_parameters(capabilities, target_duration_ms) {
    _assertClass(capabilities, DeviceCapabilities);
    const ret = wasm.devicecapabilitydetector_select_adaptive_parameters(
      this.__wbg_ptr,
      capabilities.__wbg_ptr,
      target_duration_ms
    );
...
const DevicePairingRequestFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class DevicePairingRequest {
  ...
  constructor(device_id, device_name, device_type, public_key, challenge_nonce, timestamp) {
    ...
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.devicepairingrequest_new(
      ptr0,
      len0,
      ptr1,
      len1,
...
const DevicePairingResponseFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class DevicePairingResponse {
  ...
  constructor(device_id, response_signature, shared_secret_hash, device_trust_token, timestamp) {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.devicepairingresponse_new(
      ptr0,
      len0,
      ptr1,
      len1,
...
const DeviceRegistryEntryFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class DeviceRegistryEntry {
  ...
  constructor(
    ...
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.deviceregistryentry_new(
      ptr0,
      len0,
      ptr1,
      len1,
...
const EmergencyRotationManagerFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class EmergencyRotationManager {
  ...
  triggerEmergencyRotation(trigger_type, description, affected_devices, severity) {
    ...
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      const ret = wasm.emergencyrotationmanager_triggerEmergencyRotation(
        this.__wbg_ptr,
        ptr0,
        len0,
        ptr1,
  ...
  executeEmergencyRotation(incident_id, device_ids) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.emergencyrotationmanager_executeEmergencyRotation(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  restoreDeviceAccess(device_id, incident_id) {
    ...
    const ptr1 = passStringToWasm0(incident_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.emergencyrotationmanager_restoreDeviceAccess(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const EntropySourceFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class EntropySource {
  ...
  constructor(source_type, entropy_bytes, quality_score, is_hardware_based, timestamp) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.entropysource_new(
      ptr0,
      len0,
      entropy_bytes,
      quality_score,
...
const HSMCapabilitiesFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class HSMCapabilities {
  ...
  constructor(
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.hsmcapabilities_new(
      has_hsm,
      ptr0,
      len0,
      supports_key_generation,
...
const HierarchicalKeyDerivationFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class HierarchicalKeyDerivation {
  ...
  deriveDataCategoryKey(category_str, device_id) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.hierarchicalkeyderivation_deriveDataCategoryKey(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const KeyMigrationHelperFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class KeyMigrationHelper {
  ...
  static calculate_migration_progress(total_records, migrated_records, failed_records) {
    const ret = wasm.keymigrationhelper_calculate_migration_progress(
      total_records,
      migrated_records,
      failed_records
    );
  ...
  static validate_migration_readiness(current_key, new_key) {
    ...
    const ret = wasm.keymigrationhelper_validate_migration_readiness(
      current_key.__wbg_ptr,
      new_key.__wbg_ptr
    );
    return ret;
  }
  ...
  static create_migration_batch(data_identifiers, batch_size, start_index) {
    const ret = wasm.keymigrationhelper_create_migration_batch(
      data_identifiers,
      batch_size,
      start_index
    );
  ...
  static validate_rollback_safety(current_key, rollback_version) {
    ...
    const ret = wasm.keymigrationhelper_validate_rollback_safety(
      current_key.__wbg_ptr,
      rollback_version.__wbg_ptr
    );
    return ret !== 0;
  }
}

const KeyRotationManagerFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class KeyRotationManager {
  ...
  get_key_by_version(purpose, version) {
    ...
    const ret = wasm.keyrotationmanager_get_key_by_version(
      this.__wbg_ptr,
      purpose,
      version.__wbg_ptr
    );
  ...
  update_migration_progress(purpose, progress) {
    const ret = wasm.keyrotationmanager_update_migration_progress(
      this.__wbg_ptr,
      purpose,
      progress
    );
...
const KeyRotationSchedulerFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class KeyRotationScheduler {
  ...
  postpone_rotation(purpose, additional_days) {
    const ptr0 = passStringToWasm0(purpose, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_postpone_rotation(
      this.__wbg_ptr,
      ptr0,
      len0,
      additional_days
  ...
  schedule_rotation_at(purpose, timestamp_ms) {
    const ptr0 = passStringToWasm0(purpose, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_schedule_rotation_at(
      this.__wbg_ptr,
      ptr0,
      len0,
      timestamp_ms
  ...
  enable_automatic_rotation(purpose, enabled) {
    const ptr0 = passStringToWasm0(purpose, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_enable_automatic_rotation(
      this.__wbg_ptr,
      ptr0,
      len0,
      enabled
  ...
  updateUserPreference(preference_type, value) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_updateUserPreference(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  scheduleRotationWithPreferences(purpose) {
    const ptr0 = passStringToWasm0(purpose, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_scheduleRotationWithPreferences(
      this.__wbg_ptr,
      ptr0,
      len0
    );
  ...
  isRotationAllowedNow(purpose, is_user_active) {
    const ptr0 = passStringToWasm0(purpose, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_isRotationAllowedNow(
      this.__wbg_ptr,
      ptr0,
      len0,
      is_user_active
  ...
  triggerEmergencyIncident(trigger_type, description, affected_devices, severity) {
    ...
    try {
      ...
      const ptr2 = passArrayJsValueToWasm0(affected_devices, wasm.__wbindgen_malloc);
      const len2 = WASM_VECTOR_LEN;
      const ret = wasm.keyrotationscheduler_triggerEmergencyIncident(
        this.__wbg_ptr,
        ptr0,
        len0,
        ptr1,
  ...
  detectSecurityIncident(device_id, event_data) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_detectSecurityIncident(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  updateIncidentDetectionThresholds(thresholds) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.keyrotationscheduler_updateIncidentDetectionThresholds(
      this.__wbg_ptr,
      ptr0,
      len0
    );
...
const LegacyKeyRetentionPolicyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const MasterKeyStorageInfoFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class MasterKeyStorageInfo {
  ...
  constructor(
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.masterkeystorageinfo_new(
      ptr0,
      len0,
      ptr1,
      len1,
...
const MemoryManagerFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const MemoryProtectionFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const MigrationProgressFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class MigrationProgress {
  ...
  update_progress(processed, failed, batch_number, processing_time_ms) {
    wasm.migrationprogress_update_progress(
      this.__wbg_ptr,
      processed,
      failed,
      batch_number,
...
const ModuleIntegrityFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const MultiDeviceProtocolFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class MultiDeviceProtocol {
  ...
  generate_pairing_request(device_name, device_type) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.multideviceprotocol_generate_pairing_request(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  validate_device_auth(device_id, auth_token) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.multideviceprotocol_validate_device_auth(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const PlatformEntropyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const PlatformSecureStorageFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const ProgressiveMigrationManagerFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class ProgressiveMigrationManager {
  ...
  start_migration(migration_id, total_records, timing_preferences) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.progressivemigrationmanager_start_migration(
      this.__wbg_ptr,
      ptr0,
      len0,
      total_records,
  ...
  process_next_batch(migration_id, batch_data, processed_count, failed_count) {
    const ptr0 = passStringToWasm0(migration_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.progressivemigrationmanager_process_next_batch(
      this.__wbg_ptr,
      ptr0,
      len0,
      batch_data,
  ...
  validate_rollback_safety(migration_id, current_key, rollback_version) {
    ...
    _assertClass(current_key, VersionedKey);
    _assertClass(rollback_version, KeyVersion);
    const ret = wasm.progressivemigrationmanager_validate_rollback_safety(
      this.__wbg_ptr,
      ptr0,
      len0,
      current_key.__wbg_ptr,
  ...
  calculate_optimal_batch_size(total_records, available_memory_mb, target_processing_time_ms) {
    const ret = wasm.progressivemigrationmanager_calculate_optimal_batch_size(
      this.__wbg_ptr,
      total_records,
      available_memory_mb,
...
const RecoveryPhraseFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const RecoverySystemFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class RecoverySystem {
  ...
  constructor(device_id, validation_level, max_attempts, lockout_duration_ms) {
    const ptr0 = passStringToWasm0(device_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.recoverysystem_new(
      ptr0,
      len0,
      validation_level,
      max_attempts,
  ...
  create_backup(hierarchical_key, recovery_phrase, passkey_challenge) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.recoverysystem_create_backup(
      this.__wbg_ptr,
      hierarchical_key.__wbg_ptr,
      recovery_phrase.__wbg_ptr,
      ptr0,
      len0
    );
    if (ret[2]) {
  ...
  initiate_recovery(backup_id, recovery_phrase, passkey_response) {
    ...
    try {
      ...
      const len1 = WASM_VECTOR_LEN;
      const ret = wasm.recoverysystem_initiate_recovery(
        this.__wbg_ptr,
        ptr0,
        len0,
        recovery_phrase.__wbg_ptr,
  ...
  complete_recovery(backup_id, recovery_token, recovery_phrase) {
    ...
    const len1 = WASM_VECTOR_LEN;
    _assertClass(recovery_phrase, RecoveryPhrase);
    const ret = wasm.recoverysystem_complete_recovery(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
  ...
  emergency_recovery(backup_id, recovery_phrase, emergency_code, passkey_response) {
    ...
    try {
      ...
      const len2 = WASM_VECTOR_LEN;
      const ret = wasm.recoverysystem_emergency_recovery(
        this.__wbg_ptr,
        ptr0,
        len0,
        recovery_phrase.__wbg_ptr,
...
const RotationPolicyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class RotationPolicy {
  ...
  shouldTriggerRotation(current_age_hours, usage_count, security_event) {
    const ret = wasm.rotationpolicy_shouldTriggerRotation(
      this.__wbg_ptr,
      current_age_hours,
      usage_count,
      isLikeNone(security_event) ? 7 : security_event
    );
    return ret !== 0;
  }
}

const SecureKDFFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class SecureKDF {
  ...
  static derive_key(password, salt, iterations, memory_cost, parallelism, output_length) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.securekdf_derive_key(
      ptr0,
      len0,
      ptr1,
      len1,
...
const SecureRandomFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const SecureStorageConfigFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class SecureStorageConfig {
  ...
  constructor(
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.securestorageconfig_new(
      platform,
      ptr0,
      len0,
      require_authentication,
...
const SecureTempDataFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const SecurityEventFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class SecurityEvent {
  ...
  setDeviceId(device_id) {
    var ptr0 = isLikeNone(device_id)
      ? 0
      : passStringToWasm0(device_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
...
const SideChannelProtectionFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class SideChannelProtection {
  ...
  static conditional_select_array(condition, true_array, false_array) {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.sidechannelprotection_conditional_select_array(
      condition,
      ptr0,
      len0,
      ptr1,
...
const TypeDefinitionsFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
const UserRotationPreferencesFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class UserRotationPreferences {
  ...
  get emergency_rotation_requires_confirmation() {
    const ret = wasm.userrotationpreferences_emergency_rotation_requires_confirmation(
      this.__wbg_ptr
    );
    return ret !== 0;
  }
  ...
  set emergency_rotation_requires_confirmation(requires) {
    wasm.userrotationpreferences_set_emergency_rotation_requires_confirmation(
      this.__wbg_ptr,
      requires
    );
  }
...
const VersionedKeyFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export class VersionedKey {
  ...
  can_decrypt_data_from_version(data_version) {
    ...
    const ret = wasm.versionedkey_can_decrypt_data_from_version(
      this.__wbg_ptr,
      data_version.__wbg_ptr
    );
    return ret !== 0;
  }
  /**
  ...
  supports_backward_compatibility_to(target_version) {
    ...
    const ret = wasm.versionedkey_supports_backward_compatibility_to(
      this.__wbg_ptr,
      target_version.__wbg_ptr
    );
    return ret !== 0;
  }
  /**
...
const WasmMemoryUtilsFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
...
export function __wbg_getRandomValues_38a1ff1ea09f6cc7() {
  return handleError(function (arg0, arg1) {
...
export function __wbindgen_closure_wrapper2135(arg0, arg1, arg2) {
  const ret = makeMutClosure(arg0, arg1, 174, __wbg_adapter_32);
  return ret;
}
