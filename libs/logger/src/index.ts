...
export const securityLogger = {
  ...
  auth: (event: 'login' | 'logout' | 'signup' | 'password_reset', userId?: string, success: boolean = true) => {
...
export const cryptoLogger = {
  ...
  operation: (operation: 'encrypt' | 'decrypt' | 'hash' | 'verify', algorithm: string, success: boolean, duration?: number) => {
    logger.crypto.info({
