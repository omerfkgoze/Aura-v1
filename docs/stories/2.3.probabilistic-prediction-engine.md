...
- `libs/shared-types/src/prediction.ts` - Enhanced with decision regret analysis types
- `docs/stories/2.3.probabilistic-prediction-engine.md` - Updated task completion status for Task 1, Task 2, Task 3, Task 4, and Task 5
