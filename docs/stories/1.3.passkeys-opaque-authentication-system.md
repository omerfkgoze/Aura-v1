...
- `libs/auth/src/index.ts` - Updated with recovery system exports
- `libs/auth/src/webauthn/types.ts` - Added cross-platform biometric result types
- `libs/auth/src/webauthn/index.ts` - Updated with cross-platform exports
