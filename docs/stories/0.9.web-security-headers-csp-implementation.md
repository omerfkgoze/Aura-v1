...
- `apps/web/src/security/csp-nonce-manager.ts` - Secure nonce generation and validation
- `apps/web/src/security/security-reporter.ts` - Privacy-safe security violation reporting
- `apps/web/src/security/sri-hash-generator.ts` - SRI hash generation and verification
