...
- db/migrations/001_initial_schema.sql - Core database schema with all tables
- db/migrations/002_encrypted_tables.sql - Enhanced encrypted table configurations
